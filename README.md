...
> **IMPORTANT** This sample is deprecated and will no longer be maintained. To learn how to integrate push notifications in your app see the [Basic Push sample hybrid app](http://docs.telerik.com/platform/samples/backend-services-push-hybrid/) or the [Advanced Push sample hybrid app](http://docs.telerik.com/platform/samples/backend-services-push-hybrid-advanced/). 
